# MSSQL 2014 InSpec Controls - trusted.rb
# CIS Microsoft SQL Server 2014 Benchmark v1.5.0
# Profile version: 1.5.0 (see inspec.yml)
#
# This profile implements CIS Microsoft SQL Server 2014 Benchmark controls
# for enterprise compliance scanning.
#
# Control ID Format: mssql-2014-X.XX
...
control 'mssql-2014-1.02' do
  ...
  describe sql.query("SELECT CASE WHEN CAST(SERVERPROPERTY('ProductVersion') AS VARCHAR(20)) >= '12.0.2000' THEN 'COMPLIANT' ELSE 'NOT COMPLIANT' END AS results") do
    its('rows.first.results') { should eq 'COMPLIANT' }
  end
end

control 'mssql-2014-1.03' do
  impact 0.7
